...
namespace FlexionTests
{
    ...
    public class MatiereTests
    {
        ...
        {
            Matiere matiere = new Matiere("test", 69e9);
            Assert.AreEqual(69e9, matiere.GetE());
            Assert.AreEqual("test", matiere.GetNom());
        }
        ...
        public void TestSetter()
        {
            ...
            matiere.SetE(54e6);
            matiere.SetNom("new");
            Assert.AreEqual(54e6, matiere.GetE());
            Assert.AreEqual("new", matiere.GetNom());
        }
    }
    ...
    public class CoucheTests
    {
        ...
        public void TestGetter()
        {
            Matiere matiere = new Matiere("test", 69e9);
            Couche couche = new Couche(matiere, 0.1, 0.2, 0.3, 0.4);
            Assert.AreEqual(0.1, couche.GetLargeurCenter());
            Assert.AreEqual(0.2, couche.GetLargeurSide());
            Assert.AreEqual(0.3, couche.GetHauteurCenter());
            Assert.AreEqual(0.4, couche.GetHauteurSide());
        }
        ...
        public void TestSetter()
        {
            ...
            couche.MatiereCouche = newmatiere;
            Assert.AreEqual(1, couche.GetLargeurCenter());
            Assert.AreEqual(2, couche.GetLargeurSide());
            Assert.AreEqual(3, couche.GetHauteurCenter());
            Assert.AreEqual(4, couche.GetHauteurSide());
            Assert.AreEqual(couche.MatiereCouche, newmatiere);
        }
    }
    ...
    public class PieceTests
    {
        ...
        {
            Piece piece = new Piece(1.5, "test", 69e9);
            Assert.AreEqual(1.5, piece.GetLongueur());
            Assert.AreEqual("test", piece.GetNom());
            Assert.AreEqual(69e9, piece.GetEref());
        }
        ...
        public void TestSetter()
        {
            ...
            piece.SetNom("new");
            piece.SetEref(54e6);
            Assert.AreEqual(3.5, piece.GetLongueur());
            Assert.AreEqual("new", piece.GetNom());
            Assert.AreEqual(54e6, piece.GetEref());
        }
        ...
        public void TestResultat()
        {
            ...
            Piece piece = new Piece(1500e-3, "Démo", 69e9);
